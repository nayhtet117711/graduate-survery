                ...
                <div className="container-fluid">
                    <div className="feature-inner row">
                        <div className="col-lg-4 col-md-6">
                            ...
                            <div className="px-3 rounded" style={{ width: "100%", height: 400 }}>
                                <PieChart />
                            </div>
                        </div> 
                        <div className="col-lg-2 col-md-6">
                        </div> 
                        <div className="col-lg-6 col-md-6" style={{ marginTop: -60 }}>
                            <div className=" text-center">
                                <div className="h1 py-2 text-white">Graduated Students'</div>
                                <div className="h2 py-2 text-white">Survey Results</div>
                            </div>
                            <div className=" text-center py-3 text-white" style={{ fontSize: 20 }}>
